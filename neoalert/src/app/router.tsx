...
import { AuthGuard, GuestGuard, RoleGuard } from '@shared/hooks/useAuthGuard'
import {
  ForgotPasswordPage,
  LoginPage,
  MfaPage,
...
import { RolesPage, UserFormPage, UsersPage } from '@features/admin'
...
export const appRouter = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: ROUTES.userNew, element: <UserFormPage /> },
      { path: ROUTES.userEdit, element: <UserFormPage /> },
