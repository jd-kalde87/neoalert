...
import { useOperationsBootstrap, zoneLabel } from '@shared/hooks/useOperations'
...
export function OperationsPage() {
  ...
  const { isLoading, isError, refetch } = useOperationsBootstrap()
  ...
  return (
    <section>
      ...
      <AsyncBoundary
        ...
        isError={isError}
        isEmpty={isEmpty}
        loadingTitle="Cargando catálogo operativo"
        errorTitle="No se pudo cargar plantas, sitios y rutas"
        emptyTitle={
          tab === 'plants'
            ? 'Sin plantas registradas'
            : tab === 'sites'
              ? 'Sin puntos de trabajo'
              : 'Sin rutas operativas'
        }
                  ...
                  <tr key={plant.id}>
                    ...
                    <td className="space-x-2 whitespace-nowrap">
                      ...
                      <button
                        ...
                        disabled={isDeleting}
                        onClick={() => void handleDeletePlant(plant.id, plant.name)}
                      >
                        Eliminar
                      </button>
                    </td>
                    ...
                    <tr key={route.id}>
                      ...
                      <td className="space-x-2 whitespace-nowrap">
                        ...
                        <button
                          ...
                          className="text-xs font-medium text-red-600 hover:underline"
                          disabled={isDeleting}
                          onClick={() => void handleDeleteRoute(route.id, route.name)}
                        >
                          Eliminar
                        </button>
                      </td>
