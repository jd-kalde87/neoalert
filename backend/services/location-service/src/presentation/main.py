...
from presentation.api.v1.locations_router import router as locations_router
from presentation.api.v1.maps_router import router as maps_router
...
app = FastAPI(title="NEOALERT Location Service", version="0.1.0")
