...
from presentation.api.v1.employees_router import router as employees_router
from presentation.api.v1.operations_router import router as operations_router
...
app = FastAPI(title="NEOALERT Employee Service", version="0.1.0")
